...
# Description: Backup files and remove more then 14 days old log file from source directory.
# Component: Backup and Remove script
# Date: 26/05/2026
...
SCRIPT_NAME=$(basename "$0" .sh) # this is best practice for cronjob scedule if we write SCRIPT_NAME=$(echo $0 | cut -d "." -f1) wont work.
